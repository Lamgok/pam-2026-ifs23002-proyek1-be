...
interface IEthnographyRepository {
    suspend fun getAll(userId: String, search: String, page: Int, perPage: Int): List<Ethnography>
    suspend fun getById(id: String): Ethnography?
    suspend fun create(ethnography: Ethnography): String
    suspend fun update(userId: String, id: String, newEthnography: Ethnography): Boolean
